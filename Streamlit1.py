...
CAMERA_URL = "https://83b6-103-190-46-55.ngrok-free.app/stream"  # URL kamera ESP32-CAM
...
def send_periodic_notification():
    """
    Mengirim notifikasi periodik ke Telegram setiap 5 menit dengan data suhu, kelembapan, asap, dan intensitas cahaya.
    """
    current_time = time.time()
